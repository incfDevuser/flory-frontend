...
const translations = {
  es: {
    ...
    pricing: {
      ...
      description: 'Un pago único por el dispositivo. La app gratis viene incluida para siempre.',
      ...
      cta: 'Lo quiero',
      note: 'Precios en pesos chilenos, IVA incluido.',
    },
    quiero: {
      meta: {
      ...
      availability: {
        ...
        emailTitle: 'Te avisaremos por correo.',
        emailText: 'Apenas esté disponible para comprar. Hoy no pagas ni reservas nada.',
      },
      mostPopular: 'Más elegido',
      oneTime: 'pago único',
      plans: [
      ...
      disclaimer:
        'Elegir un modelo no es una compra ni una reserva. Solo nos ayuda a saber cuál te interesa.',
    },
    lead: {
      eyebrow: 'Paso 2 de 2',
      title: '¿Dónde te avisamos?',
      description: 'Estamos fabricando los primeros Flory. Déjanos tu correo y te escribiremos apenas el tuyo esté disponible para comprar.',
      ...
      submit: 'Avísenme cuando esté disponible',
      submitting: 'Enviando…',
      errorEmail: 'Revisa el correo, parece que le falta algo.',
      errorNetwork: 'No pudimos guardar tu correo. Inténtalo de nuevo.',
      privacy: 'Esto no es una compra ni una reserva. Solo usaremos tu correo para avisarte cuando Flory esté disponible.',
    },
    gracias: {
      meta: {
      ...
      title: '¡Te avisaremos!',
      description:
        'Estamos fabricando los primeros Flory. Apenas esté disponible para comprar, recibirás un correo.',
      emailPrefix: 'Enviaremos el aviso a',
      note: 'No has comprado ni reservado nada. En esta etapa no se cobra.',
      back: 'Volver al inicio',
      alt: 'Flory saludando con la mano',
    },
    faq: {
      eyebrow: 'Dudas',
  ...
  en: {
    ...
    pricing: {
      ...
      description: 'A one-time payment for the device. The free app is included forever.',
      ...
      cta: 'I want one',
      note: 'Prices in Chilean pesos, VAT included.',
    },
    quiero: {
      meta: {
      ...
      availability: {
        ...
        emailTitle: 'We will notify you by email.',
        emailText: 'As soon as it is available to buy. You are not paying or reserving anything today.',
      },
      mostPopular: 'Most popular',
      oneTime: 'one-time payment',
      plans: [
      ...
      disclaimer:
        'Choosing a model is not a purchase or reservation. It only tells us which one you are interested in.',
    },
    lead: {
      eyebrow: 'Step 2 of 2',
      title: 'Where should we notify you?',
      description: 'We are manufacturing the first Flory devices. Leave your email and we will write as soon as yours is available to buy.',
      ...
      submit: 'Notify me when it is available',
      submitting: 'Sending…',
      errorEmail: 'Check the email, something seems to be missing.',
      errorNetwork: 'We could not save your email. Please try again.',
      privacy: 'This is not a purchase or reservation. We will only use your email to tell you when Flory is available.',
    },
    gracias: {
      meta: {
      ...
      description: 'We are manufacturing the first Flory devices. As soon as it is available to buy, you will receive an email.',
  ...
  pt: {
    ...
    pricing: {
      ...
      description: 'Um pagamento único pelo dispositivo. O app grátis vem incluído para sempre.',
      ...
      cta: 'Eu quero',
      note: 'Preços em pesos chilenos, IVA incluído.',
    },
    quiero: {
      meta: {
      ...
      availability: {
        ...
        emailTitle: 'Avisaremos você por e-mail.',
        emailText: 'Assim que estiver disponível para comprar. Hoje você não paga nem reserva nada.',
      },
      mostPopular: 'Mais popular',
      oneTime: 'pagamento único',
      plans: [
      ...
      disclaimer:
        'Escolher um modelo não é uma compra nem uma reserva. Só nos ajuda a saber qual interessa a você.',
    },
    lead: {
      eyebrow: 'Passo 2 de 2',
      title: 'Onde avisamos você?',
      description: 'Estamos fabricando os primeiros Flory. Deixe seu e-mail e escreveremos assim que o seu estiver disponível para comprar.',
      ...
      submit: 'Avise quando estiver disponível',
      submitting: 'Enviando…',
      errorEmail: 'Confira o e-mail, parece que falta algo.',
      errorNetwork: 'Não conseguimos salvar seu e-mail. Tente de novo.',
      privacy: 'Isso não é uma compra nem uma reserva. Usaremos seu e-mail apenas para avisar quando o Flory estiver disponível.',
    },
    gracias: {
      meta: {
      ...
      title: 'Vamos avisar você!',
      description: 'Estamos fabricando os primeiros Flory. Assim que estiver disponível para comprar, você receberá um e-mail.',
